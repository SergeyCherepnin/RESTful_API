...
К RESTful_API подключен Swagger(http://localhost:8080/swagger-ui.html)

Что не получилось сделать:
- попытался подключить кэш(добавив аннотацию @EnableCaching к классу ResTfulApiApplication и в сервисе повесив над методами аннотацию @Cacheble).
  Попытка оказалась неудачной. Пробовал другие аннотации для методов: @CachePut - тоже неудачно.

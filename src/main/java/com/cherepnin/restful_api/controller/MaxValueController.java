...
public class MaxValueController {
    ...
    public MaxValueController(RestfulApiService restfulApiService) {
        this.restfulApiService = restfulApiService;
    }


    @Tag(name = "Max value", description = "Max value definition")
    ...
    public ResponseEntity<?> getMaxValue(@RequestBody FilePath filePath) {
        ...
        map.put("max_value", restfulApiService.getMaxValue(filePath).toString());
